...
public class CordovaOIDCPlugin extends CordovaPlugin {
    ...
    public boolean execute(String action, JSONArray args, final CallbackContext callbackContext) throws JSONException {
        ...
        if (action.equals("createAsync")) {
            ...
            final String tokenEndpoint = args.optString(7, null).equals("null") ? "/connect/authorize" : String.format("/%1$s/authorize", args.optString(7, null));
            final String responseType = args.optString(8, null).equals("null") ? "token" : args.optString(8, null);
