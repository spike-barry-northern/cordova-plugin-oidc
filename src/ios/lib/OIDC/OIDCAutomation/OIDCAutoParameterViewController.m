...
#import "OIDCAutoParameterViewController.h"

@interface OIDCAutoParameterViewController ()

@end

@implementation OIDCAutoParameterViewController
{
    NSArray<NSString*> * _parameters;
    OIDCAutoParamBlock _completion;
...
- (id)initWithParameters:(NSArray<NSString*>*)parameters
         completionBlock:(OIDCAutoParamBlock)completionBlock
{
    if (!(self = [super init]))
    {
        return nil;
